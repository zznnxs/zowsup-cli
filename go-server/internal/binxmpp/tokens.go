// Code generated from core/layers/coder/tokendictionary.py. DO NOT EDIT.
// Source: zowsup-cli, proto 5.3 token dictionary.

package binxmpp

// PrimaryDict is the 236-entry single-byte token dictionary used by the
// WhatsApp binary XMPP codec. Indices 0..2 are reserved; entries are
// addressable as a single byte token in the 3..235 range.
var PrimaryDict = [...]string{
	"",
	"xmlstreamstart",
	"xmlstreamend",
	"s.whatsapp.net",
...
// SecondaryDict is the 1024-entry secondary dictionary, addressed as a
// two-byte token: prefix in {236,237,238,239} (= bank 0..3) followed by an
// 8-bit index into that bank.
var SecondaryDict = [...]string{
	"read-self",
	"active",
	"fbns",
	"protocol",
